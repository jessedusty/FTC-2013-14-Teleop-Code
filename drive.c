...
#pragma config(Motor,  mtr_S1_C1_1,     ringLifterAngle, tmotorTetrix, openLoop, encoder)
#pragma config(Motor,  mtr_S1_C1_2,     ringLifterLength, tmotorTetrix, openLoop, encoder)
#pragma config(Motor,  mtr_S1_C2_1,     armPivotor,    tmotorTetrix, openLoop, encoder)
#pragma config(Motor,  mtr_S1_C2_2,     gripperWrist,  tmotorTetrix, openLoop, encoder)
#pragma config(Motor,  mtr_S1_C3_1,     leftDrive,     tmotorTetrix, openLoop, reversed, encoder)
#pragma config(Motor,  mtr_S1_C3_2,     rightDrive,    tmotorTetrix, openLoop, encoder)
#pragma config(Servo,  srvo_S1_C4_1,    servo1,               tServoNone)
#pragma config(Servo,  srvo_S1_C4_2,    servo2,               tServoNone)
#pragma config(Servo,  srvo_S1_C4_3,    flipperMotor,         tServoStandard)
...
void grabberWrist()
{
	...
	ggripperWrist = motorPowerCalc(rGripperWrist, cGripperWrist, 25, 20, 25, 70);
...
void armLengthD()
{
	...
	//if (joy1Btn(9)) nMotorEncoder[ringLifterLength] = 0;
}
...
void flipper() {
	if (joy1Btn(3)) {
		servo[flipperMotor] = 0;
	} else if (joy1Btn(4)) {
		servo[flipperMotor] = 180;
	}
}

void closearms() {
	servo[whiteGripper] = 61;
	 servo[orangeGripper] = 5;
	 servo[flipperMotor] = 180;
}
